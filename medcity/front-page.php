<?php
/**
 * Front page — index.html layout only (single home layout).
 *
 * @package CCS_Theme
 */
if ( ! defined( 'ABSPATH' ) ) {
...
?>
        ...
        <div class="row row-no-gutter boxes-wrapper">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="contact-box d-flex">
              ...
              <div class="contact__content">
                <h2 class="contact__title"><?php esc_html_e( 'Our Team', 'ccs-wp-theme' ); ?></h2>
                <p class="contact__desc"><?php esc_html_e( 'Meet the people who deliver your care and support.', 'ccs-wp-theme' ); ?></p>
                <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__white btn__outlined btn__rounded">
                  <span><?php esc_html_e( 'Meet our team', 'ccs-wp-theme' ); ?></span><i class="icon-arrow-right"></i>
                </a>
              </div><!-- /.contact__content -->
            </div><!-- /.contact-box -->
          </div><!-- /.col-md-4 -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            <div class="text-with-icon">
              ...
              <div class="text__content">
                ...
                <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__secondary btn__rounded mb-70">
                  <span><?php esc_html_e( 'Meet our team', 'ccs-wp-theme' ); ?></span> <i class="icon-arrow-right"></i>
                </a>
              </div>
            </div>
            <div class="video-banner-layout2 bg-overlay">
              <img src="<?php echo esc_url( $t ); ?>/assets/images/about/2.jpg" alt="about" class="w-100">
          ...
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="about__text bg-white">
              ...
              <ul class="list-items list-unstyled">
                ...
                <li><?php esc_html_e( 'Our care team supports you and your family with a broad range of care and support needs.', 'ccs-wp-theme' ); ?>
                </li>
    ...
    <section class="services-layout1 services-carousel">
      <div class="bg-img"><img src="<?php echo esc_url( $t ); ?>/assets/images/backgrounds/2.jpg" alt="background"></div>
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="note font-weight-bold">
              ...
              <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__link btn__secondary">
                <span><?php esc_html_e( 'Meet our team', 'ccs-wp-theme' ); ?></span><i class="icon-arrow-right"></i>
              </a>
            </div>
          </div><!-- /.col-sm-6 -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/1.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/2.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
                  <i class="icon-doctor"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/3.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/4.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/5.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
                  <i class="icon-first-aid-kit"></i>
                </div>
                <h4 class="feature__title"><?php esc_html_e( 'Qualified care team', 'ccs-wp-theme' ); ?></h4>
              </div><!-- /.feature__content -->
              <a href="#" class="btn__link">
                <i class="icon-arrow-right icon-outlined"></i>
              </a>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/6.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/7.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/services/8.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading text-center mb-40">
              <h3 class="heading__title"><?php esc_html_e( 'Meet Our Team', 'ccs-wp-theme' ); ?></h3>
              <p class="heading__desc"><?php esc_html_e( 'Our team is here to support you and your family with care and enquiries.', 'ccs-wp-theme' ); ?>
              </p>
            </div><!-- /.heading -->
          </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
            ...
            <div class="slick-carousel"
              ...
              <div class="member">
                <div class="member__img">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/team/1.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>">Mike Dooley</a></h5>
                  ...
                  <div class="mt-20 d-flex flex-wrap justify-content-between align-items-center">
                    <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__secondary btn__link btn__rounded">
                      <span>Read More</span>
                      <i class="icon-arrow-right"></i>
                    </a>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/team/2.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>">Dermatologists</a></h5>
                  <p class="member__job">Cardiology Specialist</p>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/team/3.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>">Maria Andaloro</a></h5>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/team/4.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>">Dupree Black</a></h5>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/team/5.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>">Markus skar</a></h5>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/team/6.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>">Kiano Barker</a></h5>
    ...
    <section class="work-process work-process-carousel pt-130 pb-0 bg-overlay bg-overlay-secondary">
      <div class="bg-img"><img src="<?php echo esc_url( $t ); ?>/assets/images/banners/1.jpg" alt="background"></div>
      <div class="container">
              ...
              <div class="slick-carousel"
                ...
                <div class="process-item">
                  ...
                  <p class="process__desc">Medcity offers low-cost health coverage for adults with limited income, you
                    can
                    enroll.</p>
                  <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__secondary btn__link">
                    <span><?php esc_html_e( 'Our Team', 'ccs-wp-theme' ); ?></span>
                    <i class="icon-arrow-right"></i>
                  </a>
                </div><!-- /.process-item -->
                <!-- process-item #2 -->
                ...
                <div class="process-item">
                  ...
                  <h4 class="process__title"><?php esc_html_e( 'Meet our care team', 'ccs-wp-theme' ); ?></h4>
                  <p class="process__desc"><?php esc_html_e( 'Our team is here to support you and your family.', 'ccs-wp-theme' ); ?></p>
                  <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__secondary btn__link">
                    <span><?php esc_html_e( 'Our Team', 'ccs-wp-theme' ); ?></span>
                    <i class="icon-arrow-right"></i>
                  </a>
                ...
                <div class="process-item">
                  ...
                  <h4 class="process__title"><?php esc_html_e( 'Your next step', 'ccs-wp-theme' ); ?></h4>
                  <p class="process__desc"><?php esc_html_e( 'Our team have the skills to assist you.', 'ccs-wp-theme' ); ?>
                  </p>
                  <a href="<?php echo esc_url( ccs_page_url( 'our-team' ) ); ?>" class="btn btn__secondary btn__link">
                    <span><?php esc_html_e( 'Our Team', 'ccs-wp-theme' ); ?></span>
                    <i class="icon-arrow-right"></i>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-2 col-lg-2">
              <img src="<?php echo esc_url( $t ); ?>/assets/images/icons/alert2.png" class="cta__img" alt="alert">
            </div><!-- /.col-lg-2 -->
              ...
              <div class="slider-nav mb-60">
                <div class="testimonial__meta">
                  <div class="testimonial__thmb">
                    <img src="<?php echo esc_url( $t ); ?>/assets/images/testimonials/thumbs/1.png" alt="author thumb">
                ...
                <div class="testimonial__meta">
                  <div class="testimonial__thmb">
                    <img src="<?php echo esc_url( $t ); ?>/assets/images/testimonials/thumbs/2.png" alt="author thumb">
                  </div><!-- /.testimonial-thumb -->
                  <div>
                ...
                <div class="testimonial__meta">
                  <div class="testimonial__thmb">
                    <img src="<?php echo esc_url( $t ); ?>/assets/images/testimonials/thumbs/3.png" alt="author thumb">
                  </div><!-- /.testimonial-thumb -->
                  <div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="slick-carousel"
              ...
              <a class="popup-gallery-item" href="<?php echo esc_url( $t ); ?>/assets/images/gallery/1.jpg">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/gallery/1.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="<?php echo esc_url( $t ); ?>/assets/images/gallery/2.jpg">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/gallery/2.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="<?php echo esc_url( $t ); ?>/assets/images/gallery/3.jpg">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/gallery/3.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="<?php echo esc_url( $t ); ?>/assets/images/gallery/4.jpg">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/gallery/4.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="<?php echo esc_url( $t ); ?>/assets/images/gallery/5.jpg">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/gallery/5.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="<?php echo esc_url( $t ); ?>/assets/images/gallery/6.jpg">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/gallery/6.jpg" alt="gallery img">
              </a>
    ...
    <section class="contact-layout3 bg-overlay bg-overlay-primary-gradient pb-60">
      <div class="bg-img"><img src="<?php echo esc_url( $t ); ?>/assets/images/banners/3.jpg" alt="banner"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="contact-panel mb-50">
              <form class="contact-panel__form" method="post" action="<?php echo esc_url( $t ); ?>/assets/php/contact.php" id="contactForm">
                <div class="row">
                  <div class="col-sm-12">
                    <h4 class="contact-panel__title">Book An Appointment</h4>
                    <p class="contact-panel__desc mb-30"><?php esc_html_e( 'Please feel welcome to contact our friendly staff with any enquiry. We will receive or return your call.', 'ccs-wp-theme' ); ?>
                    </p>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="enquiry-type" aria-label="<?php esc_attr_e( 'Enquiry type', 'ccs-wp-theme' ); ?>">
                        <option value=""><?php esc_html_e( 'Enquiry type', 'ccs-wp-theme' ); ?></option>
                        <option value="care"><?php esc_html_e( 'Care enquiry', 'ccs-wp-theme' ); ?></option>
                        <option value="visit"><?php esc_html_e( 'Arrange a visit', 'ccs-wp-theme' ); ?></option>
                        <option value="other"><?php esc_html_e( 'Other', 'ccs-wp-theme' ); ?></option>
                      </select>
                    </div>
                  </div><!-- /.col-lg-6 -->
                  <div class="col-sm-6 col-md-6 col-lg-6">
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            ...
            <div class="slick-carousel clients-light mt-20"
              ...
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/1.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/1.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/2.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/2.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/3.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/3.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/4.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/4.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/5.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/5.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/6.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/6.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/7.png" alt="client">
                <img src="<?php echo esc_url( $t ); ?>/assets/images/clients/7.png" alt="client">
              </div><!-- /.client -->
            </div><!-- /.carousel -->
          </div><!-- /.col-lg-5 -->
        ...
        <div class="row">
            ...
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.html">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/blog/grid/1.jpg" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post__img -->
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.html">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/blog/grid/2.jpg" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post__img -->
              <div class="post__body">
                <div class="post__meta-cat">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.html">
                  <img src="<?php echo esc_url( $t ); ?>/assets/images/blog/grid/3.jpg" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post__img -->
              <div class="post__body">
                <div class="post__meta-cat">
